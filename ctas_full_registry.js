...
export default [
  ...
  // ==== Neuro ====
  {
    ...
    keywords: ['seizure', 'convulsion', 'post-ictal', 'post ictal', 'postictal', 'post ectal', 'postectal', 'status'],
  ...
  },
  {
    id: 'dizziness',
    title: 'Dizziness',
    keywords: ['dizziness', 'dizzy', 'dizzziness', 'dizzines', 'dizzyness', 'vertigo', 'lightheaded'],
  ...
  },
  {
    id: 'head_trauma',
    title: 'Head Trauma',
    keywords: ['head injury', 'head trauma', 'trauma to head', 'concussion', 'tbi', 'fall down on head', 'scalp laceration', 'forehead cut', 'fall down', 'falldown'],
  ...
  },
  {
    ...
    keywords: ['laceration', 'cut', 'cut wound', 'wound', 'puncture', 'suture', 'sutures', 'dressing'],
  ...
  // ==== Misc ====
  {
    ...
    keywords: ['weakness', 'general weakness', 'fatigue', 'lethargy', 'lethargic', 'drowsiness', 'drowsy', 'shivering'],
  ...
  // ==== Added: high-frequency chief complaints (month list) ====
  {
    id: 'cardiac_arrest',
    title: 'Cardiac Arrest / ROSC',
    keywords: ['cardiac arrest','cardaic arrest','carrdiac arrest','arrest','cpr','cpa','rosc'],
    vitalsHints: ['Immediate resuscitation, CPR, airway, rhythm'],
    modifiers: [
      { id:'no_pulse', label:'No pulse / CPR ongoing', effect:{ ctas: 1 } },
      { id:'rosc_unstable', label:'ROSC but unstable (hypotension / recurrent arrest)', effect:{ ctas: 1 } },
      { id:'rosc_stable', label:'ROSC and stable (needs urgent workup)', effect:{ ctas: 2 } },
    ],
  },
  {
    id: 'fall_down_general',
    title: 'Fall Down / Trauma (General)',
    keywords: ['fall down','falldown','fell down','fall','falling','fell'],
    vitalsHints: ['Neuro check, pain, bleeding, anticoagulants'],
    modifiers: [
      { id:'head_redflags', label:'Head injury red flags (LOC, repeated vomiting, anticoagulants, neuro deficit)', effect:{ ctas: 2 } },
      { id:'suspected_fracture', label:'Suspected fracture / deformity / cannot weight-bear', effect:{ ctas: 3 } },
      { id:'laceration_sutures', label:'Laceration needs sutures / deep wound (controlled bleeding)', effect:{ ctas: 4 } },
      { id:'minor_fall', label:'Minor fall, ambulatory, mild pain', effect:{ ctas: 5 } },
    ],
  },
  {
    id: 'fever_only',
    title: 'Fever / Shivering',
    keywords: ['fever','fevr','fever/shivering','shivering','chills','febrile','feverish','bodyache','body pain','flu'],
    vitalsHints: ['Temp, RR, SpO₂, hydration, sepsis screen'],
    modifiers: [
      { id:'septic_look', label:'Septic look / altered mental status / hypotension', effect:{ ctas: 2 } },
      { id:'unwell_dehydrated', label:'Unwell / dehydrated / persistent vomiting', effect:{ ctas: 3 } },
      { id:'well_looking', label:'Looks well, stable vitals', effect:{ ctas: 4 } },
    ],
  },
  {
    id: 'leg_swelling',
    title: 'Leg Swelling',
    keywords: ['leg swelling','swelling in legs','rtleg swelling','lt leg swelling','edema','foot swelling'],
    vitalsHints: ['DVT/PE risk, pain, neurovascular status, SOB/chest pain'],
    modifiers: [
      { id:'pe_concern', label:'Unilateral swelling + SOB / chest pain (PE concern)', effect:{ ctas: 2 } },
      { id:'dvt_concern', label:'Unilateral painful swelling (DVT concern)', effect:{ ctas: 3 } },
      { id:'mild_bilateral', label:'Bilateral mild swelling, stable', effect:{ ctas: 4 } },
    ],
  },
  {
    id: 'hypertension_cc',
    title: 'Hypertension / High BP (Chief Complaint)',
    keywords: ['hypertension','high bp','high blood pressure','htn'],
    vitalsHints: ['Repeat BP, symptoms (chest pain, neuro deficit, SOB)'],
    modifiers: [
      { id:'htn_symptoms', label:'Very high BP with symptoms (chest pain / neuro / SOB)', effect:{ ctas: 2 } },
      { id:'very_high_no_symptoms', label:'Very high BP, no symptoms', effect:{ ctas: 3 } },
      { id:'mild_stable', label:'Mild/moderate elevation, stable', effect:{ ctas: 4 } },
    ],
  },
  {
    id: 'skin_rash',
    title: 'Skin Rash / Itching',
    keywords: ['rash','rashes','skin rash','burnning and skin rashes','burning skin','itching','urticaria','allergy'],
    vitalsHints: ['Airway, facial swelling, wheeze, anaphylaxis signs'],
    modifiers: [
      { id:'airway', label:'Breathing trouble / facial swelling / anaphylaxis signs', effect:{ ctas: 1 } },
      { id:'fever_unwell', label:'Widespread rash + fever / looks unwell', effect:{ ctas: 3 } },
      { id:'localized_stable', label:'Localized rash, stable', effect:{ ctas: 5 } },
    ],
  },
  {
    id: 'wound_followup',
    title: 'Dressing / Sutures Follow-up',
    keywords: ['dressing','followup','follow-up','sutures','suture','wound followup','dressing /followup','sutures /followup'],
    vitalsHints: ['Assess infection, bleeding, pain'],
    modifiers: [
      { id:'infection_or_bleeding', label:'Infection signs or uncontrolled bleeding', effect:{ ctas: 3 } },
      { id:'painful', label:'Painful but stable', effect:{ ctas: 4 } },
      { id:'routine', label:'Routine dressing / suture removal, stable', effect:{ ctas: 5 } },
    ],
  },
  {
    id: 'hemorrhoids',
    title: 'Hemorrhoids',
    keywords: ['hemorrhoids','hemmoriods','piles','rectal pain'],
    vitalsHints: ['Bleeding amount, dizziness/syncope, pain'],
    modifiers: [
      { id:'significant_bleeding', label:'Significant bleeding / dizziness / syncope', effect:{ ctas: 2 } },
      { id:'painful', label:'Painful hemorrhoids, stable', effect:{ ctas: 4 } },
      { id:'mild', label:'Mild, stable', effect:{ ctas: 5 } },
    ],
  },
  {
    id: 'anxiety_panic',
    title: 'Anxiety / Panic',
    keywords: ['anxiety','panic','anxiety disorder'],
    vitalsHints: ['Rule-out medical causes, chest pain/SOB red flags'],
    modifiers: [
      { id:'medical_redflags', label:'Chest pain/SOB with instability or red flags', effect:{ ctas: 2 } },
      { id:'stable_panic', label:'Panic symptoms, stable vitals', effect:{ ctas: 4 } },
      { id:'mild', label:'Mild anxiety, stable', effect:{ ctas: 5 } },
    ],
  },
